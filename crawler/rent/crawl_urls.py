"""
Crawl rental listings from batdongsan.com.vn.
...
def main():
    parser = argparse.ArgumentParser(
        description="Crawl rental listings from batdongsan.com.vn"
    )
    parser.add_argument(
        "--pages", nargs=2, type=int, default=[1, 10223],
        metavar=("START", "END"), help="page range (default: 1 10223)",
    )
    parser.add_argument("--output", default="data/raw/rent_urls.csv", help="output CSV file")
