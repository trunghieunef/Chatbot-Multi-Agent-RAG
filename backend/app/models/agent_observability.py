...
class AgentTrace(Base):
    ...
    agents_used = Column(JSONB, nullable=False, default=list)
    trace_summary_json = Column(JSONB, nullable=False, default=dict)
    full_trace_json = Column(JSONB, nullable=False, default=dict)
    readiness_json = Column(JSONB, nullable=False, default=dict)
